...
type KubernetesClient interface {
	...
	ListNamespace(ctx context.Context, in *Namespace, opts ...grpc.CallOption) (*ListNamespace, error)
...
func (c *kubernetesClient) ListNamespace(ctx context.Context, in *Namespace, opts ...grpc.CallOption) (*ListNamespace, error) {
...
type KubernetesServer interface {
	...
	ListNamespace(context.Context, *Namespace) (*ListNamespace, error)
...
func (UnimplementedKubernetesServer) ListNamespace(context.Context, *Namespace) (*ListNamespace, error) {
...
func _Kubernetes_ListNamespace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubernetesServer).ListNamespace(ctx, req.(*Namespace))
	}
	return interceptor(ctx, in, info, handler)
}
